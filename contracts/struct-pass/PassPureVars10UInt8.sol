...
contract PassPureVars10Uint8 {
  ...
  function callMemoryToMemoryLibExt(uint8 a0, uint8 a1, uint8 a2, uint8 a3, uint8 a4, uint8 a5, uint8 a6, uint8 a7, uint8 a8, uint8 a9, uint count) external {
    uint gas0 = gasleft();
    for (uint i = 0; i < count; ++i) {
      PassLib.usePureVars10UInt8Memory(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, i);
    }
    gasUsed = gas0 - gasleft();
  }
  ...
  function callMemoryToMemoryLibInt(uint8 a0, uint8 a1, uint8 a2, uint8 a3, uint8 a4, uint8 a5, uint8 a6, uint8 a7, uint8 a8, uint8 a9, uint count) external {
    uint gas0 = gasleft();
    for (uint i = 0; i < count; ++i) {
      PassLib._usePureVars10UInt8Memory(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, i);
    }
    gasUsed = gas0 - gasleft();
  }

  function receiveAsMemoryInternal(uint8, uint8, uint8, uint8, uint8, uint8, uint8, uint8, uint8, uint8, uint value) internal pure returns (uint) {
    return value;
  }
  function receiveAsMemoryPublic(uint8, uint8, uint8, uint8, uint8, uint8, uint8, uint8, uint8, uint8, uint value) public pure returns (uint) {
    return value;
  }
}