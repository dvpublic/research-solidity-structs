...
import {CreateStruct4IntTest} from "../../typechain";

describe("CreateStruct4IntTest", () => {
  const COUNT_ITEMS = 10;

  let signer: SignerWithAddress;
  let ut: CreateStruct4IntTest;
  let snapshot: string;
  ...
  before(async function () {
    ...
    ut = (await DeployerUtils.deployContract(signer, 'CreateStruct4IntTest',)) as CreateStruct4IntTest;
  })
